...
class SimMST(nn.Module):
    def __init__(self, device, num_nodes, gcn_depth, dropout, input_dim, output_dim,
        ...
        for i in range(self.n_mix):
            models.append(SimST(device=device, num_nodes=num_nodes, gcn_depth=gcn_depth, dropout=dropout,
                                input_dim=input_dim[i], output_dim=output_dim[i], window=window, horizon=horizon,
                                layers=layers, residual_channels=residual_channels, conv_channels=conv_channels,
