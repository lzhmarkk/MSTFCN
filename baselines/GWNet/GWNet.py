...
from baselines.utils import calculate_scaled_laplacian, calculate_normalized_laplacian
...
class GWNet(nn.Module):
    def __init__(self, adj_mx, device, adjtype, randomadj, aptonly, nhid, input_dim, output_dim, num_nodes, kernel_size,
                 horizon, window, dropout, blocks, layers, gcn_bool, addaptadj):
        super().__init__()
        self.adj_mx = adj_mx
    ...
    def forward(self, input, **kwargs):
        ...
        # input.shape:[bs, input_dim, num_nodes, window]
        in_len = input.size(3)
